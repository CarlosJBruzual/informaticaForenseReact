...
export const LaboratorioFilters = ({ filters, onChange, onReset, variant = "glass" }) => {
        ...
        <Surface variant={variant} className="p-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className={`text-xs ${labelTone === "light" ? "text-blue-100" : "text-slate-500"}`}>
                        Filtra remisiones derivadas por expediente, PRCC o receptor.
                    </p>
                </div>
                <Frame
                    variant="ghost"
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <TextInput
                    ...
                    onValueChange={(value) => onChange("fechaRemision", value)}
                    labelTone={labelTone}
                    variant={inputVariant}
                />
                <TextInput
                    label="N° de remisión"
                    value={filters.numeroRemision}
                    onValueChange={(value) => onChange("numeroRemision", value)}
                    labelTone={labelTone}
                    variant={inputVariant}
                />
                <TextInput
